...
export default class BalancesTask<CurrencyId extends Codec> extends Task<
...
> {
  ...
  getBalance<CurrencyId>(api: ApiRx, account: string, currencyId: CurrencyId): Observable<Balance> {
